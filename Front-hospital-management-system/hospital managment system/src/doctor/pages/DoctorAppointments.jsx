...
export default function DoctorAppointments() {
  ...
  const [pendingConfirmAction, setPendingConfirmAction] = useState(null); // 'confirm' | 'complete' | 'cancel' | null
              ...
              <>
                ...
                <div>
                  ...
                  {pendingConfirmAction === null ? (
                    <div style={{ display: "flex", gap: "8px" }}>
                      {selected.status === "PENDING" && (
                        <button
                          ...
                          onClick={() => setPendingConfirmAction("confirm")}
                        >
                    ...
                    /* Inline Confirm Step */
                    <div style={{ background: "var(--bg)", padding: "12px", borderRadius: "8px", border: "0.5px solid var(--border)", textAlign: "center" }}>
                      <p style={{ margin: "0 0 10px 0", fontSize: "13px", fontWeight: 500, color: "var(--text-primary)" }}>
                        Are you sure you want to {pendingConfirmAction === "confirm" ? "confirm" : pendingConfirmAction === "complete" ? "complete" : "cancel"} this appointment?
                      </p>
                      <div style={{ display: "flex", gap: "8px", justifyContent: "center" }}>
                        ...
                        <button
                          ...
                          style={{
                            padding: "6px 12px",
                            fontSize: "12px",
                            background: pendingConfirmAction === "cancel" ? "#791F1F" : "var(--teal)"
                          }}
                          onClick={() => runAction(pendingConfirmAction)}
                          disabled={actionLoading}
                        >
                          Yes, proceed
                        </button>
