...
public interface PrescriptionService {
    PrescriptionDTO createPrescription(String doctorEmail,
                                       Long appointmentId,
                                       PrescriptionDTO dto);
    ...
    PrescriptionDTO updatePrescription(Long prescriptionId,
                                       PrescriptionDTO dto);

    ResponseDTO deletePrescription(Long prescriptionId);

    PrescriptionMedicineDTO addMedicine(Long prescriptionId,
                                        PrescriptionMedicineDTO dto);
